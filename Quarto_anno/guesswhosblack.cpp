...
individuare e stampare il giocatore con il ranking piu' alto;
individuare e stampare il giocatore piu' giovane;
...
void cercacognome(string nomi[], string cognomi[], int eta[], double ranking [], int n){
    ...
    for(int i = 0; i < n; i++){
        if (cognomericerca==cognomi[i]){
            cout << "cognome trovato!, il nome e' " << nomi[i] << endl;
            cout << "l'eta' e' " << eta[i] << endl;
            cout << "il ranking e' " << ranking[i] << endl;
        }
    }
}
...
void cercaranking(string nomi[], string cognomi[], double ranking [], int n){
    ...
    cout << "il ranking maggiore e' " << rankmax << " di " << cognomi[indice] << " " << nomi[indice] << endl;
}
...
void cercagiovane(string nomi[], string cognomi[], int eta [], int n){
    ...
    cout << "il piu' giovane e' " << cognomi[indice] << " " << nomi [indice] << " con anni " << giovane << endl;
}
...
void etasopramedia(string nomi [], string cognomi [], int eta [], int etamedia, int n){
    for (int i = 0; i < n; i++){
        if (eta[i] > etamedia){
            cout << "il giocatore " << nomi[i] << " " << cognomi[i] << " e' sopra l'età media" << endl;
        }
    }
}
 
void rankingsuperiore(double ranking[], int n){
    double inputranking = 0;
    int indice = 0;
